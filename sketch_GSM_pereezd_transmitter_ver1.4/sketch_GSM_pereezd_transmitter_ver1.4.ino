...
#define SEND_OK_PERIOD_TIME 60      //60 минут - период отправки сообщения о штатном режиме работы системы "GSM_OK"

#define SEND_NOT_OK_PERIOD_TIME 30  //30 минут - период отправки сообщения при неисправности или аварии 
...
unsigned long period_time = (long)SEND_OK_PERIOD_TIME*60*1000;   
unsigned long period_time_30_min = (long)SEND_NOT_OK_PERIOD_TIME*60*1000;
